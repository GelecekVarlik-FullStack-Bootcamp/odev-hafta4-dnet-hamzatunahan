...
namespace Northwind.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<IsYonetimContext>(ob => ob.UseSqlServer(Configuration.GetConnectionString("SqlServer")));
            services.AddScoped<DbContext, IsYonetimContext>();
            #endregion

            #region ServiceSection   // customerservice cagýrldýgýnda kendini turet 
